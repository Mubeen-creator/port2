...
<main className='w-screen h-screen relative'>
  <div className='flex items-center w-full h-full bg-cover bg-center' style={{backgroundImage: "url(/main-bg.webp)"}}>
     <div className='pl-20 ml:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-width-[750px]'>
      ...
      <p className='text-gray-200 hidden md-block'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, similique.</p>
  ...
  <div className='absolute flex bottom-10 z-[20px] right-5 flex-col md:hidden gap-5'>
        ...
        <div className='absolute bottom-0 right-0 z-[10]'>
          ...
          <Image src="/cliff.webp" alt='cliff' width={4880} height={480}/>
        </div>
